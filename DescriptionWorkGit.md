...
2. Копирование репозитория с локальной машины на удаленнsq репозиторий (GitHub.com). Для этого необходимо:
    ...
    * Отправить с локальной машины репозиторий на удаленный репозиторий:
...
3. Актуализация версии репозитория на локальной машине с его удаленной версией 
...
4. Работа с чужим удаленным репозиторием
    ...
    * Отправить с локальной машины корректированный репозиторий на удаленный репозиторий:
